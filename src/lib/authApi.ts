...
async function handleError(res: Response): Promise<never> {
	...
	const isTokenAuthFailure =
		...
		(errorCode === "invalid_token" || errorCode === "missing_token" || errorCode === "unauthorized");
...
export async function apiPost<T = unknown>(path: string, body: Record<string, any>): Promise<T> {
