...
export type Chat = {
  id: string;
  title?: string;
  messages?: { role: "user" | "assistant"; text: string; ts?: number; attachments?: any }[];
};

type ModuleType = "profile" | "settings" | "daw" | "mixer" | "createSong" | "band" | "singers" | "analytics" | "artwork" | "library" | "achievements" | "market" | "world" | "upload";
